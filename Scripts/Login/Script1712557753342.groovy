...
WebUI.setEncryptedText(findTestObject('Test_manual/Page_OrangeHRM/input_Password_password'), 'hUKwJTbofgPU9eVlw/CnDQ==')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Login'))

WebUI.navigateToUrl('https://opensource-demo.orangehrmlive.com/web/index.php/dashboard/index')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Dashboard'))

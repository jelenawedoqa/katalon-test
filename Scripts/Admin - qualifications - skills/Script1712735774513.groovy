...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/h6_Skills'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/h6_Skills'), 'Skills')
